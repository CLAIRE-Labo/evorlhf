...
SSH to the machine anc clone your repository in your PVC / shared storage.
   ...
   ```bash
   cd packing/dev && git config core.filemode false
...
...
[TEMPLATE INFO] PROJECT_ROOT_AT is set to /claire-rcp-scratch/home/moalla/packing/dev.
[TEMPLATE INFO] Expecting workdir to be /claire-rcp-scratch/home/moalla/packing/dev.
[TEMPLATE INFO] Installing the project with pip.
[TEMPLATE INFO] Expecting /claire-rcp-scratch/home/moalla/packing/dev to be a Python project.
[TEMPLATE INFO] To skip this installation use the env variable SKIP_INSTALL_PROJECT=1.
Obtaining file:///claire-rcp-scratch/home/moalla/packing/dev
  Installing build dependencies: started
  ...
  Building editable for packing (pyproject.toml): started
  ...
Successfully built packing
Installing collected packages: packing
Successfully installed packing-0.0.1
...
3. Then follow the instructions [here](https://www.jetbrains.com/help/pycharm/remote-development-a.html#gateway) and
   ...
   something like `/claire-rcp-scratch/home/moalla/packing/dev`).
...
4. Otherwise, your container prints a link to the IDE that you can find it its logs.
   ...
   ```bash
    Gateway link: jetbrains-gateway://connect#idePath=%2Fclaire-rcp-scratch%2Fhome%2Fmoalla%2Fremote-development%2Fpycharm&projectPath=%2Fclaire-rcp-scratch%2Fhome%2Fmoalla%2Fpacking%2Fdev&host=127.0.0.1&port=2223&user=moalla&type=ssh&deploy=false&newUi=true
    ```
