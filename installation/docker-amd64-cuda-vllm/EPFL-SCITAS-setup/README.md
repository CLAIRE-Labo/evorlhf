...
enroot import docker://registry.rcp.epfl.ch#claire/moalla/packing:amd64-cuda-root-latest
...
apptainer pull docker://registry.rcp.epfl.ch/claire/moalla/packing:amd64-cuda-root-latest
```
...
git pull
cd packing/dev/installation/docker-amd64-cuda
```
