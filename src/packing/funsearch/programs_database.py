        ...
        if self.temp_sampling_flag:
            ...
            if num_of_clusters_in_top_percentile > functions_per_prompt:
                ...
                wandb.log({
                    ...
                    "percentile/Percentile score": percentile_score, 
                    "percentile/Num clusters in island": number_of_clusters,
                    "percentile/Num clusters in top percentile": num_of_clusters_in_top_percentile, 
                    "percentile/Num programs in top percentile": number_of_programs_in_top_percentile, 
                })
            # else:
